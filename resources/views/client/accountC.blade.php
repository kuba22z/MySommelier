...
<form method="POST" action={{route('client_account_change')}}>
    @csrf
...
<a data-toggle="modal" data-target="#pswChangeModal"
   onclick="history.pushState({}, null, '/Kunde/Konto/Passwort/aendern')">
    <button type="button" class="btn btn-primary" id="pswChange">Passwort ändern</button>
</a>

@include('client.changePswC')
<script>
